...
export declare class L0Store {
    private readonly db;
    private readonly indexEmbeddings;
    private readonly dir;
    private readonly legacyDir;
    private readonly helper;
    private embedSvc;
    private readonly logger?;
    constructor(dataDir: string, db: MemoryDb, embed?: EmbeddingService, logger?: MemoryLogger, indexEmbeddings?: boolean);
    init(): Promise<void>;
     ...
     * 失败仅告警，绝不影响对话主流程。
     */
    prune(retentionDays: number, protectedIds: ReadonlySet<string>): Promise<number>;
    ...
    search(query: string, limit: number, visibleSessionIds?: readonly string[]): Promise<L0MessageRecord[]>;
